...
const Login = () => {
    ...
    return (
        <div className="min-h-[85vh] flex items-center justify-center -mt-4 animate-fade-in">
                ...
                <div className="hidden md:flex md:w-5/12 flex-col justify-between p-10 text-white relative overflow-hidden" style={{ background: 'linear-gradient(160deg, #1e1b4b 0%, #312e81 50%, #4338ca 100%)' }}>
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-brand-200 text-sm leading-relaxed mb-10">
                            Sign in to manage your bookings, discover new events, and stay connected.
                        </p>
                        <div className="space-y-4">
                            {[
                                { icon: <FaShieldAlt />, text: 'Secured with 2FA OTP verification' },
                                { icon: <FaCalendarAlt />, text: 'Access all your upcoming events' },
                ...
                <div className="w-full md:w-7/12 p-8 md:p-12 flex flex-col justify-center">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-sm">
                            {showOTP ? 'Enter the 6-digit code sent to your email.' : <>Don't have an account?{' '}<Link to="/register" className="text-brand-600 font-semibold hover:underline">Sign up</Link></>}
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        {!showOTP ? (
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 text-center">Verification Code (OTP)</label>
                                <input
                        ...
                        >
                            {loading ? <><Spinner /> Processing...</> : (showOTP ? 'Verify & Log In' : 'Sign In')}
                        </button>
                    </form>
                </div>
            </div>
