...
const PaymentFailed = () => {
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center p-4 animate-fade-in">
            {/* Glow backdrop */}
            <div className="absolute w-72 h-72 rounded-full opacity-15 blur-3xl pointer-events-none" style={{ background: 'radial-gradient(circle, #f87171, transparent)' }} />

            <div className="relative bg-white p-10 rounded-3xl shadow-2xl max-w-md w-full text-center border border-gray-100">
                {/* Top accent */}
                <div className="absolute top-0 left-0 right-0 h-1.5 rounded-t-3xl bg-gradient-to-r from-red-400 to-rose-500" />
                ...
                <p className="text-gray-500 mb-8 leading-relaxed">
                    We couldn't process your request. Please ensure your details are correct and try again.
                </p>

                <div className="space-y-3">
                    <Link
                        to="/"
                        className="flex items-center justify-center gap-2 w-full bg-brand-600 hover:bg-brand-700 text-white font-bold py-3.5 px-6 rounded-xl transition shadow-lg shadow-brand-100 hover:-translate-y-0.5"
                    >
